...
export default () => <DemoWrapper title="Typo">
	<h2 className="fd-text-h1 fd-text-center">Size</h2>
	...
	<div className="fd-f-left fm-c-stretch">
		...
		<span className="fd-text-h4 fd-bg-pink fd-f1 fd-f-center-middle">H4</span>
		<span className="fd-text-h2 fd-bg-green fd-f1 fd-f-center-middle">H2</span>
		<span className="fd-text-h1 fd-bg-blue fd-f1 fd-f-center-middle">H1</span>
		<span className="fd-text-h3 fd-bg-yellow fd-f1 fd-f-center-middle">H3</span>
		<span className="fd-text-h5 fd-bg-lilak fd-f1 fd-f-center-middle">H5</span>
	...
	<ul className="sg_row">
		<li className="temp-padding wide"><p className="text-left">Left</p></li>
		<li className="temp-padding wide"><p className="text-center">Center</p></li>
	...
	<ul className="temp-padding sg_row">
		<li>
