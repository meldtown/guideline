...
export default () => <DemoWrapper title="Grids">
	<div className="f-main-wrapper">
		...
		<p>All grids starts with <span className="f-text-gray">fd-[horizontal-alignment]<span className="f-text-light-gray">-[vertical-aligment]</span></span> class by default vertical alignment is kinda "stretch" and is optional, so your options are: <strong className="f-text-lilac">fd-f-left</strong>, <strong className="f-text-lilac">fd-f-center</strong>, <strong className="f-text-lilac">fd-f-right</strong></p>
		...
		<p>The only available option for vertical alignment is <strong className="f-text-lilac">middle</strong> so you may have classes like <span>fd-f-center-middle</span></p>
		...
		<p>Flex grid does not need 12 cols all we need is already here in flex box, so we have added <strong className="f-text-lilac">fd-f1</strong>, <strong className="f-text-lilac">fd-f2</strong>, <strong className="f-text-lilac">fd-f3</strong> which may be applied to cells to make them proportional wide</p>
		...
		<p>There is two additional horizontal alignments available <strong className="f-text-lilac">fd-f-around</strong> and <strong className="f-text-lilac">fd-f-between</strong></p>
