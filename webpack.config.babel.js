...
const styles = 'css-style?sourceMap!postcss-style!sass-style?sourceMap'
...
export default () => ({
	...
	module: {
		loaders: [
			{test: /\.js$/, loaders: ['babel-style']},
			{
				test: /\.s?css$/,
				loader: isProduction
					? ExtractTextPlugin.extract({fallbackLoader: 'style-style', loader: styles})
					: `style-style!${styles}`
			}
		]
	},
